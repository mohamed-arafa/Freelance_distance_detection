# 1 "D:/USB/student activity/free/ultrasonic_sensor_pic.X/main.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 288 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "D:/USB/student activity/free/ultrasonic_sensor_pic.X/main.c" 2
# 1 "D:/USB/student activity/free/ultrasonic_sensor_pic.X/config.h" 1
# 19 "D:/USB/student activity/free/ultrasonic_sensor_pic.X/config.h"
...
# 31 "D:/USB/student activity/free/ultrasonic_sensor_pic.X/config.h" 2
# 1 "D:/USB/student activity/free/ultrasonic_sensor_pic.X/main.c" 2
...
void main(void)
{
  ...
  while(1)
  {
    dist = calc_dist()/5;
    if(dist==1)
    {PORTB = 0x01; _delay((unsigned long)((50)*(4000000/4000.0)));}
    if(dist==2)
    {PORTB = 0x03; _delay((unsigned long)((50)*(4000000/4000.0)));}
    if(dist==3)
    {PORTB = 0x07; _delay((unsigned long)((50)*(4000000/4000.0)));}
    if(dist==4)
    {PORTB = 0x0F; _delay((unsigned long)((50)*(4000000/4000.0)));}
    else
    {PORTB = 0x00; _delay((unsigned long)((50)*(4000000/4000.0)));}
  }
  return;
}
